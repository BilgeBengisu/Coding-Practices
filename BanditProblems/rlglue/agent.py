...
class BaseAgent:
    ...
    @abstractmethod
    def agent_start(self, observation: Any) -> int:
    ...
    @abstractmethod
    def agent_step(self, reward: float, observation: Any, extra: Dict[str, Any]) -> int:
    ...
    @abstractmethod
    def agent_end(self, reward: float, extra: Dict[str, Any]) -> None:
