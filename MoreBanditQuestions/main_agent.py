# Adapted from University of Alberta Reinforcement Learning Coursera course
# For variable-armed bandit
...
class Agent(BaseAgent):
    ...
    def __init__(self, arms):
        ...
        self.arm_count = [0.0 for _ in range(arms)]
    ...
    def agent_step(self, reward, observation, extra):
        ...
        Args:
            ...
            observation (Numpy array): the state observation from the
                ...
                last step
            extra: extra information from the environment - ignored for now
        Returns:
